    ...
    <div class="card  shadow-hover p-3 ps-4">
        <div class="card-body"> 
            <div class="row border-bottom mb-4">
                <div class="col p-0">
                    <h4>Payment Policy Data Center</h3>
                </div>
                <div class="col">
                    <div class="text-end">
                    ...
                    @if ($hot)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a  data-toggle="modal" data-target="#Hotels__{{ $index +1 }}" class="btn btn-sm rounded-pill text-danger bg-light"><i data-feather="trash-2"></i></a>
                                <!-- Modal -->
