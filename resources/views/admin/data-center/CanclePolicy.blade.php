    ...
    <div class="card  shadow-hover p-3 ps-4">
        <div class="card-body"> 
            <div class="row border-bottom mb-4">
                <div class="col p-0">
                    <h4>Cancellation Policy Data Center</h3>
                </div>
                <div class="col">
                    <div class="text-end">
                    ...
                    <tbody>
                        @if ($hot)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="modal" class="btn btn-sm rounded-pill text-primary bg-light" data-target="#Add_Hotels_edit_model__{{ $index +1 }}"><i data-feather="edit"></i></a>
                                ...
                                <a class="btn btn-sm rounded-pill text-danger bg-light" data-toggle="modal" data-target="#Hotels__{{ $index +1 }}"><i data-feather="trash-2"></i></a> 
                                    <!-- Modal -->
