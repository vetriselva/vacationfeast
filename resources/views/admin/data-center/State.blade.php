                ...
                <tbody>
                    @if ($hot)
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-toggle="modal" class="btn-light border btn btn-sm rounded-pill text-primary" data-target="#Add_Hotels_edit_model__{{ $index +1 }}"><i data-feather="edit"></i></a>
                                ...
                                {{-- <a data-toggle="modal" data-target="#Hotels__{{ $index +1 }}" class="btn-light rounded-pill border btn btn-sm text-danger"><i data-feather="trash-2"></i></a> --}}
                                <!-- Modal -->
                    ...
                    <div > 
                        <div class="row">
                            ...
                            <div class="col-12 my-3">
                                <small>State Name</small>
                                <input type="text" name="state_name" class="mt-2 form-control "  required>
                            </div>
