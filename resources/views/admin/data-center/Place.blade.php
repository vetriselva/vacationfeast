                ...
                <tbody>
                    @if ($hot)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('edit-place',$row->id)}}" data-target="dayActivityModal" class=" rounded-pill btn btn-sm btn-light border text-primary"><i  data-feather="edit"></i></a>
                                <a href="#"  class="btn btn-sm btn-light border text-danger rounded-pill " data-toggle="modal" data-target="#Hotels__{{ $index +1 }}"><i  data-feather="trash-2"></i></a>
                    ...
                    <div > 
                        <div class="row">
                            ...
                            <div class="col-6 my-3">
                                ...
                                <input type="text" name="place_name" class="mt-2 form-control "  required>
                            </div>
